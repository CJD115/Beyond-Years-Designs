// The original Selected Work layout (featured case study + asymmetric grid).
// Kept as a reusable component; the site currently uses WorkRooms.
...
export default function WorkClassic() {
